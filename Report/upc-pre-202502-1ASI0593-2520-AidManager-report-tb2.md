...
|-------------------------|-------------------------|------------------|
| Capacidad de comunicarse efectivamente con un rango de audiencias. | **Esteban Garcia, Nicolas Sebastian** <br> **TB1**: Durante el desarrollo del proyecto, participé activamente en los procesos de deployment de la aplicación y en el testeo del aplicativo móvil. Para comunicar de manera efectiva los avances, documenté la configuración de los entornos de prueba y producción, y compartí los resultados de las pruebas funcionales con el equipo. Esto permitió al grupo técnico y a los stakeholders comprender el estado de calidad del sistema. La experiencia reforzó mi capacidad de explicar procesos complejos de integración continua y aseguramiento de calidad de forma clara. TB2: Participé en la review de Historias de Usuario y requerimientos, comunicando observaciones sobre la claridad y completitud de los criterios de aceptación. Esto ayudó a mejorar la comprensión entre desarrolladores, QA y stakeholders sobre el alcance funcional del sistema. <br><br> **Ramírez Hoffmann, Sebastián** <br> **TB1**: Participé activamente en todas las etapas del proyecto, actualizando mis conocimientos en desarrollo backend mediante tecnologías modernas. Contribuí a la definición de las *style guidelines* del sistema y comuniqué de forma clara su aplicación al resto del equipo, asegurando uniformidad. Además, traduje requerimientos técnicos a criterios de diseño centrado en el usuario dentro del enfoque Lean UX, facilitando la comprensión tanto de desarrolladores como de usuarios finales. TB2: Lideré la integración de Jira migrando la gestión desde Trello, comunicando al equipo la nueva estructura de tableros, estados y flujos de trabajo. Esto permitió mejorar la trazabilidad de las tareas y que todos entendieran el proceso de asignación y seguimiento. <br><br> **Pedro Guia Carrazco** <br> **TB1**: Reforcé mis conocimientos en gestión de proyectos aplicando metodologías ágiles, donde la comunicación en reuniones diarias y revisiones de sprint fue clave. Contribuí al desarrollo de la interfaz de usuario explicando conceptos de accesibilidad y usabilidad a compañeros no especialistas en UX. También propuse mejoras en la estructura de datos y expuse su impacto al equipo de desarrollo, logrando alinear criterios técnicos con las necesidades del producto. Me encargué de la actualización de los Sprint Planning 0 y 1, comunicando los cambios en la planificación y alineando al equipo con los objetivos de cada iteración. Esto facilitó la priorización de tareas y la coordinación efectiva en las entregas. <br><br> **Peña Rivera, Manuel Sebastian** <br> **TB1**: Durante el proyecto, comuniqué de manera efectiva lineamientos de diseño mediante la implementación de *Web Style Guidelines* y *General Style Guidelines*, lo que fortaleció la cohesión visual del sistema. Colaboré en la creación de *User Personas*, *Historias de Usuario*, *Impact Mappings* y *Customer Journeys*, comunicando estos artefactos al equipo para asegurar que todos comprendieran la relación entre funcionalidades técnicas y necesidades del usuario final. Gestioné la asignación de tareas en Jira, explicando la metodología al equipo y asegurando que cada integrante comprendiera sus responsabilidades y plazos de entrega. Esto favoreció la transparencia y la organización del flujo de trabajo. <br><br> **Andre Arroyo** [Nuevo miembro desde TB2] <br> TB2: Realicé la actualización de los diagramas C4, comunicando al equipo técnico y a los stakeholders la arquitectura del sistema en distintos niveles de abstracción. Esto permitió una mejor comprensión de la estructura del software y de las dependencias entre componentes. |Las acciones realizadas por los integrantes evidencian el uso de diferentes estrategias de comunicación dirigidas tanto a audiencias técnicas (compañeros de desarrollo, QA, diseñadores) como no técnicas (stakeholders, usuarios finales). Se logró transmitir información compleja de forma clara, facilitando la toma de decisiones y la alineación del equipo en torno a objetivos comunes. En conclusión, se cumplió el criterio al demostrar la capacidad de adaptar el lenguaje, los medios y los mensajes de acuerdo con la audiencia, garantizando comprensión y efectividad en el trabajo colaborativo. |
